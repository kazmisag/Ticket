...
#define MENU "\n\
 ...
 3 Print tickets \n\
 4 Cancel flights without any passenger \n\
 5 Create report of cancelled flights \n\"";
...
public:
    ...
    // Display the contents of Booking linked list
    /* void display(BookingManager *rhs)
     {
         for (Booking *currNode = rhs.head; currNode != nullptr;currNode=currNode->getNextNode())
         {
             std::cout << currNode->getBookingNumber() << " " << currNode->getDate()<<" "<<currNode->getSeatClass()
                       << currNode->getFirstName() << " " << currNode->getLastName() << endl;
         }
     }
     */
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        if (("flights.csv").compare(inputFile1) != 0)
        {
            throw "Flights file name Error... \nMust enter (main.exe flights.csv bookings.csv) to run the program";
            return (-1);
        }
        if (inputFile2 != BOOKINGS)
        {
            throw "Booking data file name Error... \nMust enter (main.exe flights.csv bookings.csv) to run the program";
            return (-1);
        }
        ...
        do
        {
            ...
            // Test menu choice with Switch selection
            ...
            case 3:
                ...
                break;
                // default:
                //   std::cout << "Error!... Please select the correct choice\n";
            }
            /*  // Check if user wants to continue/quit
              std::cout << "Press 0 to continue, to quit press any other key: ";
              std::cin >> option;
      */
    ...
    {
        std::cerr << "Error!... Must enter (main.exe flights.csv bookings.csv) to run the program " << '\n';
        return (-1);
    }
